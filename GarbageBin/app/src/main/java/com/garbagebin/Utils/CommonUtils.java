...
import garbagebin.com.garbagebin.MainScreen;
...
public class CommonUtils {
    ...
    public static final String GCM_SENDER_ID = "1009326785022";
...
//        }
    ...
    public static String makeLogoutReq(final Context context,final Activity activity) {
        ...
        final String Device_Token = sharedPreferences.getString(context.getResources().getString(R.string.gcm_id), "");
