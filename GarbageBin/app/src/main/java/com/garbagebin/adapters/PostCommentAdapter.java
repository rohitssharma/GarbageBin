...
public class PostCommentAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        holder.sub_comment_like_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    makeCommentLikeReq(blogid,commentid);
                }
            }
        });
    ...
    public String makeCommentLikeReq(final String blog_id,final String comment_id) {
    ...
    public void checkCommentLikeResponse(String response)
    {
        Log.e(TAG,response);
        try
        {
